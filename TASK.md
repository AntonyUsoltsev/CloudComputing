...
1. оптимизация передачи данных по сети: диспетчер заданий будет стараться задачу
   отдать тому узлу, на котором уже развернут соответствующий код и есть
   соответствующие данные;
2. сделайте механизм асинхронного запуска удаленных вычислений с поддержкой
   мониторинга прогресса;
3. обеспечьте поддержку транспорта Java-объектов;
4. обеспечьте поддержку транспорта Java-кода в форме байт-кода.